...
// Import location and required icons
...
// Location component - Handles user location selection and validation
const Location = () => {
  // State for location selection and user input
  ...
  async function fetchLocationData(userZipCode) {
    try {
      const response = await axios.get(
        `https://api.postalpincode.in/pincode/${userZipCode}`
      );
  ...
  // Handle form submission for manual pincode entry
  ...
  // Function to auto detect your location using geolocation API
  ...
  // Render the location selection UI
  return (
    <div>
      <div
      ...
      {selectedLocation && (
        <div className="w-screen h-screen text-black fixed z-50 top-0 left-0  bg-amazon_black bg-opacity-50 flex items-center justify-center">
          <div ref={locationRef} className=" w-[320px] bg-white rounded-lg">
            ...
            <form className=" p-4 flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-center">
                <input
                  ...
                  className="w-[65%] border-[1px] border-[#a6a6a6] rounded p-1 font-medium"
                  onChange={(e) => {
                ...
                />
                <button className="w-[33%] p-2 ml-2 text-center font-medium rounded-md bg-gray-200 border-[0.066rem] border-gray-300 hover:bg-gray-300 active:ring-2 active:ring-offset-1 active:ring-blue-500">
                  {" "}
                  Apply
                </button>
              </div>
            ...
            {warning && (
              <div className="flex flex-row gap-1 items-center pl-4 -mt-3 pb-2">
            ...
            <div
              onClick={getLocation}
              className="p-2 m-4 text-center font-medium rounded-md bg-gray-200 border-[0.066rem] border-gray-300 cursor-pointer hover:bg-gray-300 active:ring-2 active:ring-offset-1 active:ring-blue-500"
            >
            ...
            {autoLocationWarning && (
              <div className="flex flex-row gap-1 items-center pl-4 -mt-3 pb-2">
                <img src={required} className="w-4 h-4" alt="warning" />
                <div className="text-zsm text-red-700 ">
                  {autoLocationWarning}
                </div>
              </div>
            )}
