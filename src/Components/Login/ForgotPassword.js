...
// Import Amazon logo for branding
...
const ForgotPassword = () => {
  // State for input field and error message
  const [input, setInput] = useState("");
  const [error, setError] = useState("");
  // Validate input as email or mobile number
  const validate = () => {
  ...
  return (
    <div className="bg-white">
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="w-80 mt-4 border-[1px] rounded-lg ">
          <div className="my-4 mx-5 ">
            ...
            <form onSubmit={handleSubmit} className="my-3">
              ...
              <button
                className={`text-sm w-full text-center rounded-lg bg-yellow-300 hover:bg-yellow-400 p-[6px] mt-4 shadow active:ring-2 active:ring-offset-1 active:ring-blue-500`}
              >
                Continue
              </button>
            </form>
        ...
        {/* Help text for changed email/phone */}
