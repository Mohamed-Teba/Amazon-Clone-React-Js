...
// Import ProductsSlider for product recommendations
...
// OrderDetails component - Renders details for each order, including address and actions
const OrderDetails = ({
  ordersData,
  reversedOrders,
  handleCancelOrder,
            ...
            <div className="w-auto h-auto flex justify-between items-center gap-5 flex-wrap">
              <div className="w-auto h-auto flex flex-col mdl:flex-row gap-7">
                ...
                <div className="w-[95%] mdl:w-[70%] mx-auto flex flex-col gap-4 mt-3 justify-between">
                  ...
                  {/* Cancel and return buttons for active orders */}
